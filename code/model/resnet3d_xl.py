...
def Net(num_classes, extract_features=False, loss_type='softmax',
    ...
    if weights is not None:
        ...
        kinetics_weights = torch.load('/mnt/data1/home/sunpengzhan/something-else-idea/mycode/model/pretrained_weights/kinetics-res50.pth')
        cls_name = 'fc'
        print('\n Restoring Kintetics \n')
...
if __name__ == '__main__':
    ...
    inp = torch.rand((72, 3, 8, 224, 224)).cuda()
    out, fe = i3d(inp)
    print('out size is: ', fe.size())
