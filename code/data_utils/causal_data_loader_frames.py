...
class VideoFolder(torch.utils.data.Dataset):
    ...
    def prepare_data(self):
        ...
        if not self.is_val:
            with open('/mnt/data1/home/sunpengzhan/something-else-idea/mycode/misc/{}/{}train_vid_name.json'.format(prefix, fs_prefix),
                      'r') as f:
                vid_names = json.load(f)
                print(fs_prefix)
                print(len(vid_names))
            with open('/mnt/data1/home/sunpengzhan/something-else-idea/mycode/misc/{}/{}train_labels.json'.format(prefix, fs_prefix),
                      'r') as f:
                labels = json.load(f)
            with open(
                    '/mnt/data1/home/sunpengzhan/something-else-idea/mycode/misc/{}/{}train_frame_cnts.json'.format(prefix, fs_prefix),
                    'r') as f:
                frame_cnts = json.load(f)
        else:
            with open('/mnt/data1/home/sunpengzhan/something-else-idea/mycode/misc/{}/{}val_vid_name.json'.format(prefix, fs_prefix),
                      'r') as f:
                vid_names = json.load(f)
                print(fs_prefix)
                print(len(vid_names))
            with open('/mnt/data1/home/sunpengzhan/something-else-idea/mycode/misc/{}/{}val_labels.json'.format(prefix, fs_prefix),
                      'r') as f:
                labels = json.load(f)
            with open('/mnt/data1/home/sunpengzhan/something-else-idea/mycode/misc/{}/{}val_frame_cnts.json'.format(prefix, fs_prefix),
                      'r') as f:
                frame_cnts = json.load(f)
